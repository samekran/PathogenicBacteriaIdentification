...
RAMBO::RAMBO(int n, int r1, int b1, int K, double p, int k_input){
  std::cout << "Initializing RAMBO with parameters:" << std::endl;
  std::cout << "n: " << n << std::endl;
  std::cout << "R: " << r1 << std::endl;
  std::cout << "B: " << b1 << std::endl;
  std::cout << "K: " << K << std::endl;
  std::cout << "p: " << p << std::endl;
  std::cout << "k: " << k_input << std::endl;
  ...
  k = k_input; // number of hash functions, now passed as a parameter
